...
export default function Offer(){
    return(
        <div className="lg:w-[1240px] lg:h-[180px] w-[358px] h-[293px]  sm:w-[708px] sm:h-[153px] rounded-[20px] bg-[#000000] relative lg:left-[80px] left-3 lg:top-[90px] sm:top-[40px] overflow-x-hidden">
